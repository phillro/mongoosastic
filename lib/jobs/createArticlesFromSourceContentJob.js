                    ...
                    if (existingArticle) {
                        ...
                        if (!found) {
                            if (sourceContent.twitter_user_id) {
                                existingArticle.twitter_user_ids.push(sourceContent.twitter_user_id)
                            }
                            if (sourceContent.tweeter_id) {
                                existingArticle.tweeter_ids.push(sourceContent.tweeter_id)
                            }
                            existingArticle.referencing_tweet_ids.push(sourceContent.tweet_id)
                            existingArticle.save(function (existingArticleSaveError, existingArticleSaveResult) {
                        ...
                        async.waterfall([
                            ...
                            function (publication, stepTwoCallback) {
                                ...
                                if (sourceContent.twitter_user_id) {
                                    articleData.twitter_user_ids = [sourceContent.twitter_user_id]
                                }
                                if (sourceContent.tweeter_id) {
                                    articleData.tweeter_ids= [sourceContent.tweeter_id]
                                }
                                if (publication) {
